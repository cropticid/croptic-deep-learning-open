...
class CoDINOUAVHead(CoDeformDETRHead):
    ...
    def __init__(self,
        ...
        super(CoDINOUAVHead, self).__init__(
    ...
    def forward(self,
        ...
        mlvl_feats = mlvl_feats[1:] # Exclude first feature because uav_detr doest need 
        num_level = len(mlvl_feats)
        start = 0

        #for i in range(len(mlvl_feats)):
        #    print(i, mlvl_feats[i].shape)
